...
sudo expect <(wget -qO- https://raw.githubusercontent.com/electrocuted-slug/rpizw-bthid-pi-lite/master/bluetooth.sh) $address

sudo mkdir /opt/rpi-bthid-pi-lite
sudo chown -R $USER:$USER /opt/rpi-bthid-pi-lite
wget https://raw.githubusercontent.com/electrocuted-slug/rpizw-bthid-pi-lite/master/rfcomm-server.py /opt/rpi-bthid-pi-lite/rfcomm-server.py
wget https://raw.githubusercontent.com/electrocuted-slug/rpizw-bthid-pi-lite/master/bluetooth_adv.sh /opt/rpi-bthid-pi-lite/bluetooth_adv.sh
